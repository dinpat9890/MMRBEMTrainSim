...
set DMI_FE_REGISTRY=%DEPLOY_ENV%\DMIFrontendObserver.properties
set DMI_FE_HUB_REGISTRY=%DEPLOY_ENV%\DMIFrontendHubObserver.properties
set DMI_FE_APP_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManagerObserver.properties
set DMI_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManagerSimObserver.properties
