...
public class DoorSystemTestScreenBinder extends AbstractCommsListener
{

  private TestSystemScreenModel testSystemScreenModel;

  public DoorSystemTestScreenBinder(TestSystemScreenModel testSystemScreenModel)
  {
    super();
  ...
  {
    if (key.equals(IAppOutputsTestSystemScreenProperties.DOOR_SYSTEM_TEST_STATUS))
    {
      testSystemScreenModel.setActiveTestStatusList((byte[])newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.DOOR_TEST_TOTAL_PAGE))
    {
      testSystemScreenModel.setTotalPageNumber((Integer)newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.DOOR_TEST_CURRENT_PAGE))
    {
