 ...
 * ==================================================================
 */
package com.sydac.mmrbem.tcms.fe.gui;
 ...
 * 
 */
public abstract class AbstractTCMSController extends AbstractController
{
  private static final int RESET_VALUE = 0;

  protected ArrayList<AbstractCommsListener> tcmsScreenBinders = new ArrayList<>();
  ...
  public final void initialize()
  {
    ...
    tcmsScreenBinders.forEach(b -> b.attachToModel(TCMSFactory.getCommsBinding(scenarioCarIndex)));

    appInputsSetter = TCMSFactory.getCommsBinding(scenarioCarIndex).getHubInputsValuesSetter();
  }
  ...
  {
    tcmsScreenBinders.forEach(AbstractCommsListener::detachFromModel);
    detachListeners();
  }
