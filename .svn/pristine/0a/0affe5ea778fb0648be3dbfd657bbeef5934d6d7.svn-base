 ...
 * ==================================================================
 */
package com.sydac.mmrbem.radio.backend.vehicle.io.handlers;

import com.sydac.foundation.IPropertySetter;

/**
 * This interface supplies mutators for vehicle input variables.
 * 
 * @author savanjin
 */
public interface IVehicleInputsHandler extends IPropertySetter
{}
