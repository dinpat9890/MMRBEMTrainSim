...
/// @file       FlightSimHardware.h
///
///             Declares the FlightSimHardware class. 
///
...
#ifndef FLIGHTSIM_HARDWARE_WRAPPER
#define FLIGHTSIM_HARDWARE_WRAPPER
...
#include "SydacCommon/Utilities.h"
#include "SydacCommon/OSThreadClasses.h"
#include "SydacCommon/OSClasses.h"
...
class FlightSimHardware : private Sydac::Unique
{
public:
...
public:
    ...
    FlightSimHardware(const std::string &port, int baud_rate, int data_bits, int parity, int stop_bits, double poll_period, int poll_retries, double cmd_delay=0);
    ~FlightSimHardware();
...
private:
    ...
    std::auto_ptr<OS::Thread> m_pcommandThread;
...
#endif FLIGHTSIM_HARDWARE_WRAPPER
