...
import com.sydac.mmrbem.dmi.backend.app.DMIBackendModule;

/**
 * The Class DateTimeModel that stores simulated time.
 * 
 * This class is used to set time when runCycle method get called in
 * {@link DMIBackendModule}. Session start time will be set as the default time.
 * 
 */
public class DateTimeModel extends Model
{
  ...
  /**
   * Sets time when runCyle in{@link DMIBackendModule} updated and fires
   * TIME_CHANGE event.
   *
   * @param aTime
   *          the new time
