...
REM  This batch file will execute the TCMS Backend
...
call ..\Environment\TCMSBackendEnvironment.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %TCMS_BE_APP_REGISTRY% %TCMS_BE_APP_SIM_REGISTRY% %TCMS_USER_CREDENTIALS_INI% %TCMS_PROPERTIES_REGISTRY% %TCMS_HUB_REGISTRY% %TCMS_TEXT_MESSAGE_REGISTRY%
