 ...
 * ==================================================================
 */
package com.sydac.mmrbem.radio.fe.app;
...
import com.sydac.mmrbem.radio.fe.base.CommsListenerManager;
 ...
 * 
 */
public class RadioApplication extends AbstractApplication
{
  ...
  {
    RadioApplication.xpos = xpos;
    RadioApplication.ypos = ypos;
    RadioApplication.width = width;
    RadioApplication.height = height;
    RadioApplication.sceneManager = sceneManager;

    if (!applicationInitiated.getAndSet(true))
    {
      Platform.setImplicitExit(false);
      Application.launch(RadioApplication.class, new String[] {});
    }
  }
  ...
  public static final void showApplication(final int carIndex, DBScenarioTrain dbScenarioTrain)
  {
    ...
    Platform.runLater(() -> {
      sceneManager.setSize(RadioApplication.width,RadioApplication.height);
  ...
  {
    RadioApplication.applicationStage.initStyle(StageStyle.TRANSPARENT);
  }
