@echo off
title TCMS Instructor Frontend
...
call ..\Environment\TCMSFrontendEnvironment_Instructor.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %TCMS_FE_REGISTRY% %TCMS_FE_HUB_REGISTRY% %TCMS_FE_INSTRUCTOR_APP_REGISTRY% %TCMS_FE_APP_SIM_REGISTRY% %TCMS_HUB_REGISTRY% %TCMS_PROPERTIES_REGISTRY%

REM============================================================
REM============================================================

@title TCMS Frontend Instructor
echo %CLASSPATH%
