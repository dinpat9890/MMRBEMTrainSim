function set_up_test_modelCB(TrainConfiguration)

    %% Set defaults
    if(~exist('TrainConfiguration', 'var'))
        TrainConfiguration = table;
        TrainConfiguration.Class = ["DM", "T", "M", "T", "M", "M", "T", "DM"]';
        TrainConfiguration.Orientation = [1 1 1 1 1 2 2 2]';
        TrainConfiguration.Index = [0 1 2 3 4 5 6 7]';
        
    end
    assignin('base', 'MaxVehicles', 8); %Default MaxVehicles
