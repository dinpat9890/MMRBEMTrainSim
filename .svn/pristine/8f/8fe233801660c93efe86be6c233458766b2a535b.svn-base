 ...
 *
 */
public final class PAPISFrontendModule extends AbstractFxFrontendModule
{
  /**
   * @param unitCreators
   *          unit creators
   ...
   */
  public PAPISFrontendModule(Collection<UnitCreator> unitCreators, CommsConnectionInfo connectionInfo)
  {
   ...
   *          connection information
   */
  public PAPISFrontendModule(CommsConnectionInfo connectionInfo)
  {
  ...
  {
    return new PAPISFrontendPanelManager(this);
  }
