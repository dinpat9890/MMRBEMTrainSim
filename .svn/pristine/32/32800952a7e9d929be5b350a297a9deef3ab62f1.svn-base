...
public class HVCommandTCarController extends AbstractTCMSController
{
  ...
  public HVCommandTCarController(CarConfigurationModel carConfig,
  ...
  public void initializeImpl()
  {
    ...
    pantoSelectButtonProperty = new NodePseudoClassProperty(pantoSelectBtn);
  ...
  private void pantoSelectStateUpdate()
  {
    if (Objects.equals(pantoState.get().getComponentState(), Pantograph.RAISED.toString().toLowerCase()))
    {
      ...
      pantoSelectBtn.setText(TCMSUIConstants.SELECT_TXT);
    }
    else
    {
      checkPantoSelected();
  ...
  private void checkPantoSelected()
  {
    if (pantoSelected)
    {
      ...
      pantoSelectBtn.setText(TCMSUIConstants.DESELECT_TXT);
    }
    else
    {
