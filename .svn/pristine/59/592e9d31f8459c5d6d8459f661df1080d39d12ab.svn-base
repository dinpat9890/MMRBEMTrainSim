...
/**
 * Created Automation Script for Tcms using sikuli tool.
 *
 * @author ext-asatis
 */
...
public class Tcms {
	...
	private void tcms() throws IOException {
		try {
			 ...
			 * S.click(FilePathConstant.IMAGE_PATH + "SoftPLC.PNG"); S.wait(2.0);
			 * 
			 * S.find(FilePathConstant.IMAGE_PATH + "controlKey.PNG");
			 * S.click(FilePathConstant.IMAGE_PATH + "controlKey.PNG"); S.wait(2.0);
			 * 
