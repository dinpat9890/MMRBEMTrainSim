...
REM============================================================
start "Saloon-CCTV-FE"      /min cmd.exe /c CCTVFrontend.bat
start "Saloon-CCTV-BE"      /min cmd.exe /c CCTVUnit.bat
start "VisionCCTV"          /min cmd.exe /c VisionCCTV.bat
start "RadioUnit"           /min cmd.exe /c RadioUnit.bat
start "Radio Backend"       /min cmd.exe /c RadioBackend.bat
start "Radio Frontend"      /min cmd.exe /c RadioFrontend.bat
