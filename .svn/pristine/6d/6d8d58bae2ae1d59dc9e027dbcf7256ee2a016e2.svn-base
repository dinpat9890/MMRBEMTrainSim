CREATE OR REPLACE PACKAGE CommonListBuilder IS
/**********************************************************************************************************************
...
**********************************************************************************************************************/
    ...
    *                                      turned on                           
    ******************************************************************************************************************/
    PROCEDURE SequencesAdd(p_sequence_tab IN OUT CommonUtilities.sequence_tabtype, p_debug IN VARCHAR);  
...
END; -- CommonListBuilder Package Spec
/
