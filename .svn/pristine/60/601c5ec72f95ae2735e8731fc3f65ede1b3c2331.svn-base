...
set PSD_RIGHT_FE_HUB_REGISTRY=%DEPLOY_ENV%\PSDRightFrontendHub.properties
set PSD_RIGHT_FE_APP_REGISTRY=%DEPLOY_ENV%\PSDRightFrontendApplicationManager.properties
set PSD_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\PSD_RightFrontendApplicationManagerSim.properties
