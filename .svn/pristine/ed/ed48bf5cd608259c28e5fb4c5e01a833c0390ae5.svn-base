...
public class XMLParser extends DefaultHandler
{
  ...
  List<RouteDetailModel> routeModelList = new LinkedList<>();
  ...
  {
    File file = new File(PSDPropertiesReader.getPSDRouteListFilePath());
    if (!file.exists())
    {
  ...
  public String getRouteCode(int routeId)
  {
    ...
    for (RouteDetailModel route : routeModelList)
    {
