...
public class BrakeSystemCommandsIsolatePanelController2 extends AbstractTCMSController
{
  ...
  public BrakeSystemCommandsIsolatePanelController2(CarConfigurationModel carConfig,
