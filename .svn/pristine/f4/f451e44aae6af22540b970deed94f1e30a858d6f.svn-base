...
set DMI_FE_REGISTRY=%DEPLOY_ENV%\DMIFrontendInstructor.properties
set DMI_FE_HUB_REGISTRY=%DEPLOY_ENV%\DMIFrontendHubInstructor.properties
set DMI_FE_APP_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManagerInstructor.properties
set DMI_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManagerSimInstructor.properties
