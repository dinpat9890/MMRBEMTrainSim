...
set RADIO_FE_REGISTRY=%DEPLOY_ENV%\RadioFrontend.properties
set RADIO_FE_HUB_REGISTRY=%DEPLOY_ENV%\RadioFrontendHub.properties
set RADIO_FE_APP_REGISTRY=%DEPLOY_ENV%\RadioFrontendApplicationManager.properties
set RADIO_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\RadioFrontendApplicationManagerSim.properties
