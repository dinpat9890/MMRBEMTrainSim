...
set PT_APP_REGISTRY=%DEPLOY_ENV%\PTApplicationManager.properties
set PT_APP_SIM_REGISTRY=%DEPLOY_ENV%\PTApplicationManagerSim.properties
set PT_HUB_REGISTRY=%DEPLOY_ENV%\PTHub.properties
set PT_REGISTRY=%DEPLOY_ENV%\PT.properties

set PT_ARGS=%PT_APP_REGISTRY% %PT_APP_SIM_REGISTRY% %PT_REGISTRY% %PT_HUB_REGISTRY%
