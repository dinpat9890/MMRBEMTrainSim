...
call ..\Environment\DMIFrontendEnvironmentObserver.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %DMI_FE_REGISTRY% %DMI_FE_HUB_REGISTRY% %DMI_FE_OBSERVER_APP_REGISTRY% %DMI_FE_APP_SIM_REGISTRY% %DMI_HUB_REGISTRY%

REM============================================================
REM============================================================

@title DMI Frontend Observer
echo %CLASSPATH%
