...
import com.sydac.mmrbem.tcms.common.application.IRunCycleBroadcaster;
import com.sydac.mmrbem.tcms.common.application.IRunCycleListener;
import com.sydac.mmrbem.tcms.common.state.ApplicationConstants;
import com.sydac.mmrbem.tcms.common.utils.timer.CommsTimerManager;
 ...
 *
 */
public class TCMSBackendModule extends BackendModule implements IRunCycleBroadcaster
{
   ...
   */
  public TCMSBackendModule(CommsConnectionInfo connectionInfo)
  {
  ...
  private void initializeCommsTimerManager(Gateway gateway, BaseSessionData aSessionData)
  {
    ...
    DateTimeModel.getInstance().setStartTime(sessionSimStartTimeUTCMillis);
    gateway.scheduleTimerCallback(elapsedTimeInMillis -> {
      ...
      DateTimeModel.getInstance().setTime(currentSimTimeInMillis);
