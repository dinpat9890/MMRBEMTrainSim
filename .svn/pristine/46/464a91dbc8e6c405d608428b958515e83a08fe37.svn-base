...
set PT_Observer_APP_REGISTRY=%DEPLOY_ENV%\PTApplicationManager_Observer.properties
set PT_Observer_APP_SIM_REGISTRY=%DEPLOY_ENV%\PTApplicationManagerSim_Observer.properties
set PT_Observer_HUB_REGISTRY=%DEPLOY_ENV%\PTHub_Observer.properties
set PT_REGISTRY=%DEPLOY_ENV%\PT.properties

set PT_ARGS=%PT_Observer_APP_REGISTRY% %PT_Observer_APP_SIM_REGISTRY% %PT_REGISTRY% %PT_Observer_HUB_REGISTRY%
