...
PSD ============================================================
PSD
PSD  This File is used to define TMS application environment variables
...
PSD ============================================================
PSD
PSD  The following section sets the generic PSD IDU Frontend properties

set PSD_INSTRUCTOR_FE_REGISTRY=%DEPLOY_ENV%\PSDFrontend.properties
set PSD_INSTRUCTOR_FE_HUB_REGISTRY=%DEPLOY_ENV%\PSDFrontendHub_Instructor.properties
set PSD_INSTRUCTOR_FE_APP_REGISTRY=%DEPLOY_ENV%\PSDFrontendApplicationManager_Instructor.properties
set PSD_INSTRUCTOR_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\PSDFrontendApplicationManagerSim_Instructor.properties
