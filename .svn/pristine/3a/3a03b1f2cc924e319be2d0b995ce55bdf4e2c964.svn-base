...
{
    //**** Place this block appropriate location ***//
    ...
    {
        unit_creators.push_back(
            [&]()
            {
                std::shared_ptr<dva::Properties> pis_properties = std::make_shared<dva::Properties>(*g_properties);
                return std::make_shared<dva::DVAUnit>(gateway, pis_properties);
            });
    }
