...
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %TCMS_FE_REGISTRY% %TCMS_FE_HUB_REGISTRY% %TCMS_FE_INSTRUCTOR_APP_REGISTRY% %TCMS_FE_APP_SIM_REGISTRY% %TCMS_HUB_REGISTRY%
