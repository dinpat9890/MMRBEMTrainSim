 ...
 * {@link RadioFactory#register(int, HubObjectProvider)} will be addressed by the
 * TMSFactory.
 * 
...
public final class RadioFactory
{
  ...
  private static final String SERVICE_HANDLER_IMPL = System.getProperty(FRONTEND_SERVICE_HANDLER_IMPL_KEY,
      "com.sydac.mmrbem.radio.fe.base.impl.ServiceRequestHandlerImpl"); //$NON-NLS-1$
   ...
   *         {@link RadioFactory#register(int, HubObjectProvider)}-ed for this
   *         carIndex<br>
   *         null otherwise
   */
