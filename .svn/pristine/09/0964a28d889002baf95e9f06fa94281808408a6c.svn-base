...
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_1_CAR_7_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_2_CAR_7_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_3_CAR_7_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_4_CAR_7_ISO_BUTTON;


import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_1_CAR_8_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_2_CAR_8_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_3_CAR_8_ISO_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.PECU_4_CAR_8_ISO_BUTTON;
...
import com.sydac.mmrbem.papis.fe.gui.view.ViewPackage;
...
public class PecuIsolateScreenEightCarController extends AbstractPAPISController
{
  ...
  @FXML
  @CommsNumber(PECU_1_CAR_7_ISO_BUTTON)
   private Button car7Pecu1Btn1;
  
  @FXML
  @CommsNumber(PECU_2_CAR_7_ISO_BUTTON)
  private Button car7Pecu2Btn2;
  
  @FXML
  @CommsNumber(PECU_3_CAR_7_ISO_BUTTON)
  private Button car7Pecu3Btn3;
  
  @FXML
  @CommsNumber(PECU_4_CAR_7_ISO_BUTTON)
  private Button car7Pecu4Btn4;
  
  @FXML
  @CommsNumber(PECU_1_CAR_8_ISO_BUTTON)
  private Button car8Pecu1Btn1;
  
  @FXML
  @CommsNumber(PECU_2_CAR_8_ISO_BUTTON)
  private Button car8Pecu2Btn2;
  
  @FXML
  @CommsNumber(PECU_3_CAR_8_ISO_BUTTON)
  private Button car8Pecu3Btn3;
  
  @FXML
  @CommsNumber(PECU_4_CAR_8_ISO_BUTTON)
  private Button car8Pecu4Btn4;
  ...
  private NodePseudoClassProperty car7Pecu1BtnProperty;

  private NodePseudoClassProperty car7Pecu2BtnProperty;

  private NodePseudoClassProperty car7Pecu3BtnProperty;

  private NodePseudoClassProperty car7Pecu4BtnProperty;
  
  
  private NodePseudoClassProperty car8Pecu1BtnProperty;

  private NodePseudoClassProperty car8Pecu2BtnProperty;

  private NodePseudoClassProperty car8Pecu3BtnProperty;

  private NodePseudoClassProperty car8Pecu4BtnProperty;
  ...
  public void initializeImpl()
  {
   // sixCarGrid.setVisible(true);
    ...
    car7Pecu1BtnProperty = new NodePseudoClassProperty(car7Pecu1Btn1);
    car7Pecu2BtnProperty = new NodePseudoClassProperty(car7Pecu2Btn2);
    car7Pecu3BtnProperty = new NodePseudoClassProperty(car7Pecu3Btn3);
    car7Pecu4BtnProperty = new NodePseudoClassProperty(car7Pecu4Btn4);
    
    car8Pecu1BtnProperty = new NodePseudoClassProperty(car8Pecu1Btn1);
    car8Pecu2BtnProperty = new NodePseudoClassProperty(car8Pecu2Btn2);
    car8Pecu3BtnProperty = new NodePseudoClassProperty(car8Pecu3Btn3);
    car8Pecu4BtnProperty = new NodePseudoClassProperty(car8Pecu4Btn4);
    ...
    propertyMap.put(car7Pecu1Btn1, car7Pecu1BtnProperty);
    propertyMap.put(car7Pecu2Btn2, car7Pecu2BtnProperty);
    propertyMap.put(car7Pecu3Btn3, car7Pecu3BtnProperty);
    propertyMap.put(car7Pecu4Btn4, car7Pecu4BtnProperty);
    
    propertyMap.put(car8Pecu1Btn1, car8Pecu1BtnProperty);
    propertyMap.put(car8Pecu2Btn2, car8Pecu2BtnProperty);
    propertyMap.put(car8Pecu3Btn3, car8Pecu3BtnProperty);
    propertyMap.put(car8Pecu4Btn4, car8Pecu4BtnProperty);
    ...
    pecuIdMap.put(car7Pecu1Btn1, 25);
    pecuIdMap.put(car7Pecu2Btn2, 26);
    pecuIdMap.put(car7Pecu3Btn3, 27);
    pecuIdMap.put(car7Pecu4Btn4, 28);
    
    pecuIdMap.put(car8Pecu1Btn1, 29);
    pecuIdMap.put(car8Pecu2Btn2, 30);
    pecuIdMap.put(car8Pecu3Btn3, 31);
    pecuIdMap.put(car8Pecu4Btn4, 32);
