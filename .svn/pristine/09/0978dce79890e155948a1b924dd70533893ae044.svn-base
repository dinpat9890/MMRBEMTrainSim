...
public class FaultsTableDO
{
  ...
  public FaultsTableDO(Integer orderId, Integer faultId, String carCode, String faultCode, Integer faultLevel,
      String faultSystemName, String faultDescription, String faultOccuranceDateTime, String faultComponent,
      String operatorGuide, boolean faultAcknowledged)
  {
    super();
