 ...
 *          value
 */
public class TCMSOutputsTrainViewScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsTrainViewScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue, int aCarIndex,
