 ...
 *          value
 */
public class TCMSOutputsWFLSystemScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsWFLSystemScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue, int aCarIndex,
