 ...
 *          value
 */
public class TCMSOutputsFireDetectionSystemScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsFireDetectionSystemScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue,
      int aCarIndex, V aHandler, List<VehicleDetailModel> aVehicleDetailModelList)
  {
