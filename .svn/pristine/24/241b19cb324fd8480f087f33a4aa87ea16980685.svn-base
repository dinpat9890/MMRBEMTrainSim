...
call ..\Environment\PAPISFrontendEnvironment.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %PAPIS_FE_REGISTRY% %PAPIS_FE_HUB_REGISTRY% %PAPIS_FE_APP_REGISTRY% %PAPIS_FE_APP_SIM_REGISTRY%

REM============================================================
REM============================================================

@title PAPIS Frontend
echo %CLASSPATH%
