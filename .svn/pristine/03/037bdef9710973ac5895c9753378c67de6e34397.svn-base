...
import com.sydac.mmrbem.papis.common.utils.timer.CommsTimerManager;
 ...
 *
 */
public class PAPISBackendModule extends BackendModule implements IRunCycleBroadcaster
{
   ...
   */
  public PAPISBackendModule(CommsConnectionInfo connectionInfo)
  {
