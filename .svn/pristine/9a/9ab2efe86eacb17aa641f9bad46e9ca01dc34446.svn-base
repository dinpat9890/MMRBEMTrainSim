...
public class SystemTestScreenBinder extends AbstractCommsListener
{

  private TestSystemScreenModel testSystemScreenModel;

  public SystemTestScreenBinder(TestSystemScreenModel testSystemScreenModel)
  {
    super();
  ...
  {
    if (key.equals(IAppOutputsTestSystemScreenProperties.SYSTEM_TEST_STATUS))
    {
      testSystemScreenModel.setActiveTestStatusList((byte[])newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.SYSTEM_TEST_TOTAL_PAGE))
    {
      testSystemScreenModel.setTotalPageNumber((Integer)newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.SYSTEM_TEST_CURRENT_PAGE))
    {
