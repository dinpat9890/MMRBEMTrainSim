...
-extern_plugin "../../../../../software/oksygen/sim/core/unigine_plugins/vision_manager_plugin/bin/vision_manager_plugin,../../../../../software/oksygen/sim/core/tools/vision_studio/bin/unigine2_track_mesh_builder,../../../../../software/oksygen/sim/core/tools/vision_studio/bin/unigine2_extruder,../../../../../software/oksygen/sim/core/tools/vision_studio/bin/unigine2_collapse" ^
-vision_manager_plugin_cfg vision.ini ^
-editor_plugin "SydacPanel.plugin,DuncanCommander.plugin,unigine2_track_mesh_builder/unigine2_track_mesh_builder.plugin,extruder/extruder.plugin,collapse/collapse.plugin" ^
