...
#include <vehicles/common/DoorControl.us.cpp>
#include <WorldProject.us.cpp>
// This file is in UnigineScript language.
// World script, it takes effect only when the world is loaded.

//World-specific environment track files.
Environment::g_sun_pitch_track_file        = "mmrbem/graphics/tracks/sun_pitch.track";
Environment::g_cloud_track_file            = "mmrbem/graphics/tracks/cloud.track";
