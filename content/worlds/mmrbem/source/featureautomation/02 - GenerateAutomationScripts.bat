...
%EXE_FOLDER%\feature_automation_encoder.exe    -il=.\FeatureAutomationScripts\Input\AutomationScriptInputFiles.txt ^
                                               -os=.\FeatureAutomationScripts\Output\MMRBEM_ControlTable.script ^
                                               -od=..\..\definition\Mumbai_Metro_L2_L7_Track.xml ^
