...
call %EXE_FOLDER%\feature_importer.exe FeaturePlacement_Charkop_depot.ini
call %EXE_FOLDER%\feature_importer.exe FeaturePlacement_Line_2A.ini
call %EXE_FOLDER%\feature_importer.exe FeaturePlacement_Line_7.ini
