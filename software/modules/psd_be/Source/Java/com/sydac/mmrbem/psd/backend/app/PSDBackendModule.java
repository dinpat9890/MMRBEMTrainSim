...
import com.sydac.mmrbem.psd.common.application.IRunCycleBroadcaster;
import com.sydac.mmrbem.psd.common.application.IRunCycleListener;
import com.sydac.mmrbem.psd.common.data.ApplicationConstants;
import com.sydac.mmrbem.psd.common.utils.timer.CommsTimerManager;
...
/**
 * Entry point for running the PSD Backend as a Comms Module.
 *
 */
public class PSDBackendModule extends BackendModule implements IRunCycleBroadcaster
{
  ...
  /**
   * Instantiates a new PSD backend module.
   *
   * @param connectionInfo
   *          Connection information to connect to Comms
   */
  public PSDBackendModule(CommsConnectionInfo connectionInfo)
  {
  ...
  protected IVehicleBackend createVehicleBackend(DBScenarioTrain aTrain, int aCarIndex)
  {
    ...
    if (aCarIndex == scenarioVehicleIndex)
    {
      ...
      return applicationContext.getVehiclePSD();
    }
    return null;
  }
