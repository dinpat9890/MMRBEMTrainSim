package com.sydac.mmrbem.dmi.backend.test.utils;
...
public class TestCommsBinding extends CommsBinding
{
  ...
  {
    TestPropertyContainer setter = new TestOutputBindingBuilder(IAppOutputsProperties.class)
        .setRawConverter(byte[].class, (byte[] b) -> b).build();
    appOutputsSetter = FeBeOutputHandlerFactory.createWithInterfaces(setter, IAppOutputsProperties.class,
        IAppOutputsHandler.class);
    appOutputsModel = setter;
  }
  ...
  public void onVehicleOutputsObjectCreation(CObject cObject, int aVehicleIndex)
  {
    ...
    vehicleOutputsModels.put(aVehicleIndex, vehicleOutputsModel);
  }
  ...
  public void onApplicationInputsObjectCreation(CObject cObject)
  {
    ...
    appInputsSetter = appInputsModel;
  }
