...
public interface IFunctionalLogic extends IListenerManager
{
  ...
  default <T> void radioIntercomOutputPropertyUpdated(PropertyKey<T> key, T oldValue, T newValue,
  ...
  default <T> void tcmsVehicleOutputsPropertyUpdated(PropertyKey<T> key, T oldValue, T newValue,
      int vehicleIndex)
  {}
