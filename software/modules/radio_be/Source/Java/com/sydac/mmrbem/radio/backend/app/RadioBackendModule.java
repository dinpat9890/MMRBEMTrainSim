...
import com.sydac.mmrbem.radio.common.application.IRunCycleBroadcaster;
import com.sydac.mmrbem.radio.common.application.IRunCycleListener;
import com.sydac.mmrbem.radio.common.state.ApplicationConstants;
import com.sydac.mmrbem.radio.common.utils.timer.CommsTimerManager;
...
/**
 * Entry point for running the TCMS Backend as a Comms Module.
 *
 */
public class RadioBackendModule extends BackendModule implements IRunCycleBroadcaster
{
  ...
  private long simulationDateAndTimeInMillis;
  ...
  /**
   * Instantiates a new TCMS backend module.
   *
   * @param connectionInfo
   *          Connection information to connect to Comms
   */
  public RadioBackendModule(CommsConnectionInfo connectionInfo)
  {
  ...
  protected IVehicleBackend createVehicleBackend(DBScenarioTrain aTrain, int aCarIndex)
  {
    ...
    if (aCarIndex == scenarioVehicleIndex)
    {
      ...
      return applicationContext.getVehicleTCMS();
    }
    return null;
  }
  ...
  protected void doResetSession()
  {
    ...
    simulationDateAndTimeInMillis = 0;
  ...
  private void initializeCommsTimerManager(Gateway gateway, BaseSessionData aSessionData)
  {
    ...
    gateway.scheduleTimerCallback(elapsedTimeInMillis -> {
      simulationDateAndTimeInMillis = sessionSimStartTimeUTCMillis + (long)(elapsedTimeInMillis * 1000L);
      for (IRunCycleListener runCycleListener : runCycleListeners)
      {
        runCycleListener.runCycle(simulationDateAndTimeInMillis);
      }
  ...
  {
    return simulationDateAndTimeInMillis;
  }
