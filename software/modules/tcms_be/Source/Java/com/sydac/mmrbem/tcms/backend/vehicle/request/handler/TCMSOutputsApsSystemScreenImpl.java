 ...
 *          value
 */
public class TCMSOutputsApsSystemScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsApsSystemScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue, int aCarIndex,
