 ...
 *          value
 */
public class TCMSOutputsBrakeSystemScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsBrakeSystemScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue, int aCarIndex,
