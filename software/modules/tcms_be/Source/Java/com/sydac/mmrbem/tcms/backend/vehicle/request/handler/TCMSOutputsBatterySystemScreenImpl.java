 ...
 *          value
 */
public class TCMSOutputsBatterySystemScreenImpl<T, V> extends TCMSOutputsRequestImpl<T, V>
{
  protected final List<VehicleDetailModel> vehicleDetailModelList;

  public TCMSOutputsBatterySystemScreenImpl(PropertyKey<Integer> aKey, T aOldValue, T aNewValue,
