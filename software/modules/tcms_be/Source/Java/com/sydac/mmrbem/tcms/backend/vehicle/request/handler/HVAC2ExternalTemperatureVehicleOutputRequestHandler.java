...
/**
 * This class handles HVAC 2 External Temperature update from vehicle outputs.
 * 
 */
public class HVAC2ExternalTemperatureVehicleOutputRequestHandler implements
    ITCMSVehicleOutputsRequestHandler<TCMSOutputsHVACSystemScreenImpl<Integer, IAppOutputsHVACSystemScreenHandler>>
{

  private List<Entry<VehicleExternalTemperatureValueDO>> externalTemperatureStatus2 = new ArrayList<>();
      ...
      TCMSOutputsHVACSystemScreenImpl<Integer, IAppOutputsHVACSystemScreenHandler> request)
  {
    try
    {
      VehicleExternalTemperatureValueDO vehicleExternalTemperatureValueDO = ITCMSVehicleOutputsRequestHandler
          .getVehicleStatusDo(externalTemperatureStatus2, request.getCarIndex(),
              VehicleExternalTemperatureValueDO.class);
      vehicleExternalTemperatureValueDO.setExternalTemperature(request.newValue);
      ITCMSVehicleOutputsRequestHandler.updateVehicleStatusDOList(externalTemperatureStatus2,
          vehicleExternalTemperatureValueDO, request.getCarIndex());
      setExternalTemperatureStatus(externalTemperatureStatus2,
          builder -> request.getHandler().setExternalTemperatureStatus2(builder.build().toByteArray()));
    }
