 ...
 *
 */
public final class RadioFrontendModule extends AbstractFxFrontendModule
{
  /**
   * @param unitCreators
   *          unit creators
   ...
   */
  public RadioFrontendModule(Collection<UnitCreator> unitCreators, CommsConnectionInfo connectionInfo)
  {
   ...
   *          connection information
   */
  public RadioFrontendModule(CommsConnectionInfo connectionInfo)
  {
  ...
  {
    return new RadioFrontendPanelManager(this);
  }
