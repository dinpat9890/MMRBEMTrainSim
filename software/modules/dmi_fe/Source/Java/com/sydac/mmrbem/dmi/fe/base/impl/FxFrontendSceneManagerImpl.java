 ...
 * ==================================================================
 */
package com.sydac.mmrbem.dmi.fe.base.impl;
...
import com.sydac.mmrbem.dmi.fe.gui.view.ViewPackage;
...
public class FxFrontendSceneManagerImpl implements IFxFrontendSceneManager
{
  ...
  public Scene createScene(String screenName, int carIndex, ApplicationControllerFactory controllerFactory)
  {
    ...
    try
    {
      ...
      {
        GridPane pane = FXMLLoader.load(ViewPackage.class.getResource(screenName + FXML_EXT), null, null,
            controllerFactory);
        // Create the scene
        ...
        outerPanelGridPane.add(pane, 0, 0);
