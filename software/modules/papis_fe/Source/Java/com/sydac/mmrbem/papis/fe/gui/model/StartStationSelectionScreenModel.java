...
public class StartStationSelectionScreenModel extends AbstractScreenModel
{

  private StringProperty startStationNameProperty = new SimpleStringProperty();

  private IntegerProperty startStationSelected = new SimpleIntegerProperty();
  ...
  public StartStationSelectionScreenModel(int carIndex)
  {
    super(carIndex);
  }
  ...
  public StringProperty getStartStationNameProperty()
  {
    return startStationNameProperty;
  }

  public void setStartStationNameProperty(byte[] startStationNameProperty)
  {
    this.startStationNameProperty.set(new String(startStationNameProperty));
  }

  public IntegerProperty getStartStationSelected()
  {
    return startStationSelected;
  }

  public void setStartStationSelected(Integer newValue)
  {
    startStationSelected.set(newValue);
  }
}
