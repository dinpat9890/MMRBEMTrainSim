 ...
 * ==================================================================
 */
package com.sydac.mmrbem.papis.fe.i18n;

import java.text.MessageFormat;

import com.sydac.common.i18n.libintl.LibIntl;

public class PAPPISFrontendI18N
{
  private static final String DOMAIN = "PAPISFrontend"; //$NON-NLS-1$

  private static final LibIntl libIntl = new LibIntl(DOMAIN);

  /** Can't be constructed */
  private PAPPISFrontendI18N()
  {}
