...
import com.sydac.mmrbem.papis.fe.app.PAPISApplication;
import com.sydac.mmrbem.papis.fe.base.impl.FxFrontendSceneManagerImpl;
import com.sydac.mmrbem.papis.fe.base.utils.TimeUtil;
import com.sydac.mmrbem.papis.fe.comms.CommsBinding;
import com.sydac.mmrbem.papis.fe.comms.CommsBindingImpl;
 ...
 */
public class PAPISFrontendPanelManager extends AbstractFrontendPanelManager
{
  ...
  public PAPISFrontendPanelManager(PeerApplication baseApplication)
  {
      ...
      int carIndex)
  {
    ...
    PAPISFactory.register(carIndex, hubObjectProvider);
    PAPISFactory.register(carIndex, new CommsBindingImpl(aGateway, carIndex));
  }
      ...
      BaseSessionData aSessionData, boolean aIsSimulation, IHubObjectCallback aCallback)
  {
    ...
    Map<Integer, CommsBinding> commsBindingMap = PAPISFactory.getCommsBinding();
    ...
    // FrontendModule execution path
    {
      ...
      {
        int carIndex = commsBindingEntry.getKey();
        callbacks.put(carIndex, new PAPISCompositeHubObjectCallback(carIndex, commsBindingEntry.getValue(),
    ...
    if (aIsSimulation)
    {
      monitor = new IODataObjectCreator(aGateway, aApplicationName, logicalHubId, creatorId,
          ProjectObjectConstants.ClassId.PAPIS, scenarioTrainId, callbacks,
          ProjectObjectDefinition.getObjectDefinition(ProjectObjectConstants.ClassId.PAPIS_INPUTS),
          ProjectObjectDefinition.getObjectDefinition(ProjectObjectConstants.ClassId.PAPIS_OUTPUTS),
          ProjectObjectDefinition.getObjectDefinition(ProjectObjectConstants.ClassId.PAPIS_INPUTS_VALUES));
  ...
  public void createFxApplication(int carIndex, Properties properties)
  {
    ...
    PAPISApplication.startApplication(xpos, ypos, width, height, sceneManager);
  }
  ...
  public void showFxApplication(final int carIndex, final boolean show)
  {
    if (show)
    {
      PAPISApplication.showApplication(carIndex, dbScenarioTrain);
    }
    else
    {
      PAPISApplication.hideApplication();
    }
  }
  ...
  {
    PAPISApplication.pauseApplication(pause);
  }
   ...
   * @author Nazim Oliyath
   */
  public static final class PAPISCompositeHubObjectCallback implements IHubObjectCallback
  {
    ...
    public PAPISCompositeHubObjectCallback(int carIndex, IHubObjectCallback hubObjectCallback,
  ...
  protected static final class FxHubObjectCallback implements IHubObjectCallback
  {
    ...
    {
      hubObjectCallback.onHubInputCreation(hubInput);
      CommsListenerManager.attachToModel(carIndex, PAPISFactory.getCommsBinding(carIndex));
    }
