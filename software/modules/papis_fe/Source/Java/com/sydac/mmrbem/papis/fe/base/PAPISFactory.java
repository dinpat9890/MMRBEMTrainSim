 ...
 * {@link PAPISFactory#register(int, HubObjectProvider)} will be addressed by the
 * TMSFactory.
 * 
 * @author Nazim Oliyath
 * 
 */
public final class PAPISFactory
{
  ...
  private static final String SERVICE_HANDLER_IMPL = System.getProperty(FRONTEND_SERVICE_HANDLER_IMPL_KEY,
      "com.sydac.mmrbem.papis.fe.base.impl.ServiceRequestHandlerImpl"); //$NON-NLS-1$

  private PAPISFactory()
  {
   ...
   *         {@link PAPISFactory#register(int, HubObjectProvider)}-ed for this
   *         carIndex<br>
   *         null otherwise
   */
