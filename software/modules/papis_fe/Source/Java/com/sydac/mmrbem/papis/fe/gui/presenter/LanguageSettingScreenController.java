...
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.LANG_SCREEN_BACK_BUTTON;
import static com.sydac.project.runtimedata.ProjectObjectConstants.PAPISInputs.LANG_SCREEN_OK_BUTTON;
...
public class LanguageSettingScreenController extends AbstractPAPISController
{

  @FXML
  @CommsNumber(LANG_SCREEN_OK_BUTTON)
  private Button langScreenOkBtn;

  @FXML
  @CommsNumber(LANG_SCREEN_BACK_BUTTON)
  private Button langScreenBackBtn;
