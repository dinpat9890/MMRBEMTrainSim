...
public class HighVoltageDMCarController extends AbstractTCMSController
{
  ...
  public HighVoltageDMCarController(CarConfigurationModel carConfig,
      HighVoltageScreenModel highVoltageScreenModel, String carLabel)
  {
