...
public class BatterySystemTestScreenBinder extends AbstractCommsListener
{

  private TestSystemScreenModel testSystemScreenModel;

  public BatterySystemTestScreenBinder(TestSystemScreenModel testSystemScreenModel)
  {
    super();
  ...
  {
    if (key.equals(IAppOutputsTestSystemScreenProperties.BATTERY_SYSTEM_TEST_STATUS))
    {
      testSystemScreenModel.setActiveTestStatusList((byte[])newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.BATTERY_TEST_TOTAL_PAGE))
    {
      testSystemScreenModel.setTotalPageNumber((Integer)newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.BATTERY_TEST_CURRENT_PAGE))
    {
