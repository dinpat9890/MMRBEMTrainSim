...
/**
 * This class acts as a controller for Car Orientation 1-2.
 * 
 */
public class DoorsIsolateCommandsPanelController extends AbstractTCMSController
{
  ...
  public DoorsIsolateCommandsPanelController(CarConfigurationModel carConfig,
  ...
  public void initializeImpl()
  {
    ...
    doorA1State.addListener(observable -> updateDoorA1ButtonState());
    doorA2State.addListener(observable -> updateDoorA2ButtonState());
    doorA3State.addListener(observable -> updateDoorA3ButtonState());
    doorA4State.addListener(observable -> updateDoorA4ButtonState());
    doorB1State.addListener(observable -> updateDoorB1ButtonState());
    doorB2State.addListener(observable -> updateDoorB2ButtonState());
    doorB3State.addListener(observable -> updateDoorB3ButtonState());
    doorB4State.addListener(observable -> updateDoorB4ButtonState());
