...
public class PISSystemTestScreenBinder extends AbstractCommsListener
{

  private TestSystemScreenModel testSystemScreenModel;

  public PISSystemTestScreenBinder(TestSystemScreenModel testSystemScreenModel)
  {
    super();
  ...
  {
    if (key.equals(IAppOutputsTestSystemScreenProperties.PIS_TEST_STATUS))
    {
      testSystemScreenModel.setActiveTestStatusList((byte[])newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.PIS_TEST_TOTAL_PAGE))
    {
      testSystemScreenModel.setTotalPageNumber((Integer)newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.PIS_TEST_CURRENT_PAGE))
    {
