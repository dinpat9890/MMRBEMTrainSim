...
public class HVACSystemTestScreenBinder extends AbstractCommsListener
{

  private TestSystemScreenModel testSystemScreenModel;

  public HVACSystemTestScreenBinder(TestSystemScreenModel testSystemScreenModel)
  {
    super();
  ...
  {
    if (key.equals(IAppOutputsTestSystemScreenProperties.HVAC_SYSTEM_TEST_STATUS))
    {
      testSystemScreenModel.setActiveTestStatusList((byte[])newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.HVAC_TEST_TOTAL_PAGE))
    {
      testSystemScreenModel.setTotalPageNumber((Integer)newValue);
    }
    else if (key.equals(IAppOutputsTestSystemScreenProperties.HCVAC_TEST_CURRENT_PAGE))
    {
