...
public class CCTVHybridLeftPanelController extends AbstractTCMSController
{

  @FXML
  private GridPane leftHybridPanelGrid;
  ...
  public void initializeImpl()
  {
    ...
    hybridPanelSideListener = (observable, oldVal, newVal) -> updateLeftHybridPanelActive(newVal.intValue());
    ...
    updateLeftHybridPanelActive(hybridModeScreenModel.getHybridPanelActiveSide().get());
  ...
  private void updateLeftHybridPanelActive(int leftActive)
  {
    leftHybridPanelGrid.setVisible(leftActive == TCMSUIConstants.LEFT_PANEL_ACTIVE);
  }
  ...
  {
    TCMSFactory.getServiceRequestHandler(scenarioCarIndex)
        .sendActiveHybridPanelSideReq(TCMSUIConstants.RIGHT_PANEL_ACTIVE);
  }

  @FXML
  public void onMoveRightButtonAction(ActionEvent event)
  {
    movePanelToRight();
  }
}
