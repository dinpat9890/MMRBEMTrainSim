...
public class RBCommandMCarController extends AbstractTCMSController
{
  ...
  public RBCommandMCarController(CarConfigurationModel carConfig, RbCommandScreenModel rbCommandScreenModel)
  {
