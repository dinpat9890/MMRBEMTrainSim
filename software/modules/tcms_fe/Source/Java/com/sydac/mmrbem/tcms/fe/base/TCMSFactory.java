 ...
 * {@link TCMSFactory#register(int, HubObjectProvider)} will be addressed by the
 * TMSFactory.
 * 
 * @author Nazim Oliyath
 * 
 */
public final class TCMSFactory
{
  ...
  private static final String SERVICE_HANDLER_IMPL = System.getProperty(FRONTEND_SERVICE_HANDLER_IMPL_KEY,
      "com.sydac.mmrbem.tcms.fe.base.impl.ServiceRequestHandlerImpl"); //$NON-NLS-1$
   ...
   *         {@link TCMSFactory#register(int, HubObjectProvider)}-ed for this
   *         carIndex<br>
   *         null otherwise
   */
