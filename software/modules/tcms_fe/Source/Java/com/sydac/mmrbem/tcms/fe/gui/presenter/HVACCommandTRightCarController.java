...
public class HVACCommandTRightCarController extends AbstractTCMSController
{
  ...
  public HVACCommandTRightCarController(CarConfigurationModel carConfig,
  ...
  void isolateHvac1BtnAction(ActionEvent event)
  {
        ...
        HVACOperatingState.HVAC_OPERATING_ISOLATED.toString()))
    {
      ...
      TCMSFactory.getServiceRequestHandler(scenarioCarIndex).sendRequest(VDUInputs.ISOLATE_HVAC1_CAR6_REQ,
  ...
  void isolateHvac2BtnAction(ActionEvent event)
  {
    ...
    if (Objects.equals(havac2State.get().getComponentState(),
        HVACOperatingState.HVAC_OPERATING_ISOLATED.toString()))
    {
      TCMSFactory.getServiceRequestHandler(scenarioCarIndex).sendRequest(VDUInputs.ISOLATE_HVAC2_CAR6_REQ,
          TCMSUIConstants.REINSERT_VALUE);
    }
    else
    {
