...
public class HVACCommandTMiddleCarController extends AbstractTCMSController
{
  ...
  public HVACCommandTMiddleCarController(CarConfigurationModel carConfig,
  ...
  void isolateHvac1BtnAction(ActionEvent event)
  {
        ...
        HVACOperatingState.HVAC_OPERATING_ISOLATED.toString()))
    {
      ...
      TCMSFactory.getServiceRequestHandler(scenarioCarIndex).sendRequest(VDUInputs.ISOLATE_HVAC1_CAR3_REQ,
  ...
  void isolateHvac2BtnAction(ActionEvent event)
  {
    ...
    if (Objects.equals(havac2State.get().getComponentState(),
        HVACOperatingState.HVAC_OPERATING_ISOLATED.toString()))
    {
      TCMSFactory.getServiceRequestHandler(scenarioCarIndex).sendRequest(VDUInputs.ISOLATE_HVAC2_CAR3_REQ,
          TCMSUIConstants.REINSERT_VALUE);
    }
    else
    {
