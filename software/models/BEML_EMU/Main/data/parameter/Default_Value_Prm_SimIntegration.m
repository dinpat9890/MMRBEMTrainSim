...
function [default_value] = Default_Value_Prm_SimIntegration(prm_datatype)
  ...
  default_value.Brakes		= Default_Value_Brakes_Prm();
  ...
  default_value.Coupling    = Default_Value_Prm_CouplingSystem();
