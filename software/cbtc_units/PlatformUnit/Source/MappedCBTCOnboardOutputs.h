...
///
///  Description:    CBTC Onboard Interface into the Platform Controller
...
struct MappedCBTCOnboardOutputs : MappableObject
{
    ...
    void MapCBTCOnboardOutputs(Comms::Object &object, double request_frequency)
    {
        ...
        MapNumber(&localisation_status, Project::ValueName::CBTCOnboardOutputs::LOCALISATION_STATUS);
        RequestAndRetrieve();
    }
