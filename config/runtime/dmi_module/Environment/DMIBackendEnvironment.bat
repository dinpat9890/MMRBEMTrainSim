...
set DMI_BE_JAR=%DEPLOY_LIB%\dmibackend.jar
set DMI_COMMON_JAR=%DEPLOY_LIB%\dmicommon.jar;%DEPLOY_LIB%\protos-serialisation.jar
...
set SPRING_CONTEXT_JAR=%DEPLOY_LIB%\spring-context.jar
...
set CLASSPATH=%FEBE_UTILS_JAR%;%DMI_BE_JAR%;%DMI_COMMON_JAR%;%CONFIG_DATA_JAR%;%TRAIN_DATA_JARS%;%SIMULATOR_CONTROLLER_JAR%;%COMMS_LOGGING_JAR%;%SPRING_CORE_JAR%;%SPRING_ASM_JAR%;%SPRING_AOP_JAR%;%SPRING_BEANS_JAR%;%SPRING_CONTEXT_JAR%;%SPRING_EXPRESSION_JAR%;%PROTO_SERIALIZATION_JAR%;%COMMS_STRUCTURE_JAR%;%LOOKS_JAR%;%CLASSPATH%;
...
set DMI_BE_APP_REGISTRY=%DEPLOY_ENV%\DMIBackendApplicationmanager.properties
set DMI_BE_APP_SIM_REGISTRY=%DEPLOY_ENV%\DMIBackendApplicationmanagersim.properties
set DMI_REGISTRY=%DEPLOY_ENV%\DMI.properties
set SYSTEM_SHUTDOWN_REGISTRY=%DEPLOY_ENV%\SystemShutdown.properties
set DMI_HUB_REGISTRY=%DEPLOY_ENV%\Hub.properties
set DMI_TEXT_MESSAGE_REGISTRY=%DEPLOY_ENV%\DMITextMessages.properties
set DMI_PROPERTIES_REGISTRY=%DEPLOY_ENV%\DMI.properties
