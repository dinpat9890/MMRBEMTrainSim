...
set DMI_FE_HUB_REGISTRY=%DEPLOY_ENV%\DMIFrontendHub.properties
set DMI_FE_Observer_APP_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManager_Observer.properties
set DMI_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\DMIFrontendApplicationManagerSim.properties
