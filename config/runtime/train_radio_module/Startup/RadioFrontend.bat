...
call ..\Environment\RadioFrontendEnvironment.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %RADIO_FE_REGISTRY% %RADIO_FE_HUB_REGISTRY% %RADIO_FE_APP_REGISTRY% %RADIO_FE_APP_SIM_REGISTRY% %RADIO_HUB_REGISTRY%

REM============================================================
REM============================================================

@title Radio Frontend
echo %CLASSPATH%
