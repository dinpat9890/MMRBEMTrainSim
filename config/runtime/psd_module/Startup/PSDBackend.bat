...
REM  This batch file will execute the PSD Backend
...
call ..\Environment\PSDBackendEnvironment.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %PSD_BE_APP_REGISTRY% %PSD_BE_APP_SIM_REGISTRY% %PSD_USER_CREDENTIALS_INI% %PSD_PROPERTIES_REGISTRY% %PSD_HUB_REGISTRY% 
