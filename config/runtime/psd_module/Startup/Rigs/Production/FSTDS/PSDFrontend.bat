...
call ..\Environment\PSDFrontendEnvironment.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %PSD_FE_REGISTRY% %PSD_FE_HUB_REGISTRY% %PSD_FE_APP_REGISTRY% %PSD_FE_APP_SIM_REGISTRY% %PSD_HUB_REGISTRY%
