...
set PSD_FE_REGISTRY=%DEPLOY_ENV%\PSDFrontend.properties
set PSD_FE_HUB_REGISTRY=%DEPLOY_ENV%\PSDFrontendHub.properties
set PSD_FE_APP_REGISTRY=%DEPLOY_ENV%\PSDFrontendApplicationManager.properties
