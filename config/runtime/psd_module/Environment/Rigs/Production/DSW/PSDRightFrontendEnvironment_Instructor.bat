...
set PSD_RIGHT_FE_APP_REGISTRY=%DEPLOY_ENV%\PSDRightFrontendApplicationManager_Instructor.properties
set PSD_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\PSD_RightFrontendApplicationManagerSim_Instructor.properties
