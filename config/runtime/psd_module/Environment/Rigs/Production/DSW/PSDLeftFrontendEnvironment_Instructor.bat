...
PSD ============================================================
PSD
PSD  The following section sets the generic PSD Left Frontend properties

set PSD_LEFT_FE_REGISTRY=%DEPLOY_ENV%\PSDLeftFrontend.properties
set PSD_LEFT_FE_HUB_REGISTRY=%DEPLOY_ENV%\PSDLeftFrontendHub_Instructor.properties
set PSD_LEFT_FE_APP_REGISTRY=%DEPLOY_ENV%\PSDLeftFrontendApplicationManager_Instructor.properties
set PSD_FE_APP_SIM_REGISTRY=%DEPLOY_ENV%\PSDFrontendApplicationManagerSim_Instructor.properties
