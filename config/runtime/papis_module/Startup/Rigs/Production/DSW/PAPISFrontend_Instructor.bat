@echo off
title PAPIS Instructor Frontend
...
call ..\Environment\PAPISFrontendEnvironment_Instructor.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %PAPIS_INSTRUCTOR_FE_REGISTRY% %PAPIS_INSTRUCTOR_FE_HUB_REGISTRY% %PAPIS_INSTRUCTOR_FE_APP_REGISTRY% %PAPIS_INSTRUCTOR_FE_APP_SIM_REGISTRY%
