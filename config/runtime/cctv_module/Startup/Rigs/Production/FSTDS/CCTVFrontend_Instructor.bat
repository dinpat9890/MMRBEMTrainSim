...
call ..\Environment\CCTVFrontendEnvironment_Instructor.bat

set JVM_ARGS=%COMMON_JVM_ARGS% -ms128m -mx512m
set JAVA_ARGS=%COMMON_JAVA_ARGS% %HUB_REGISTRY% %CCTV_FE_REGISTRY% %CCTV_FE_HUB_REGISTRY% %CCTV_FE_INSTRUCTOR_APP_REGISTRY% %CCTV_FE_APP_SIM_REGISTRY% %CCTV_HUB_REGISTRY%

REM============================================================
REM============================================================

@title CCTV Instructor Frontend
echo %CLASSPATH%
